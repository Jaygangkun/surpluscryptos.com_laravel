...
<div class="app-body">
    ...
    <div class="white-area">
        ...
        <p>
            2. <b>Term of CCA –</b> The term of this CCA will be <b class="show_years"></b> years <b class="show_months"></b> months. The <b class="show_years"></b>
    ...
    <div class="white-area articl-iv">
        ...
        <p>
            ...
            its maturity date of <b class="show_years"></b> years, from the Contract Start Date of <b class="show_months"></b> months.
        ...
        <table class="table-x-iii">
            ...
            <tr>
                <td>
                    ...
                    <a href="javascript:" onclick="initSignevent('reset')"
                       style="color: purple!important;background:unset !important;"
                       class="text-danger text-sm">Reset</a>
                    <input type="hidden"
{{--                           name="signature"--}}
                           class="signature-input"
                           id="signature-input"/>
                </td>
                <td><h2>{{date('m/d/Y')}}</h2></td>
            </tr>
        </table>
    </div>
</div>
